...
export const Card = forwardRef<CardHandle, CardProps>(({ card, location, onClick, isPlayable }, ref) => {
  ...
  return (
    <div 
      ...
      onClick={onClick}
      className={`w-[120px] h-[180px] cursor-pointer relative origin-bottom select-none ${isPlayable ? 'ring-2 ring-neon-cyan shadow-[0_0_15px_#00f5ff80] rounded-xl' : ''}`}
    >
